    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="/"><h2 class="font-weight-bold text-light">K04API</h2></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Nguyễn Hoàng Phúc <i class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu" style="border: 1px solid grey;">
                                <a class="dropdown-item" href="#"><i class="fa-light fa-coins"></i> &mdash; Số dư: 100.000đ</a>
                                <a class="dropdown-item" href="#"><i class="fa-duotone fa-user-astronaut"></i> &mdash; Tài khoản</a>
                                <a class="dropdown-item" href="#"><i class="fa-solid fa-arrow-right-from-bracket"></i> &mdash; Đăng xuất</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span style="text-transform: none;">Ngân hàng</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-box-shadow">
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        ...
                                        <span style="padding-top: 20px" class="text-dark"><p style="text-align: justify; padding-right: 5px">Khi thanh toán nâng cấp, hãy sử dụng nút <b>sao chép</b> để tránh ghi sai nội dung bạn nhé.</p></span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <div class="footer-area">
                <p>website made with love by <b style="cursor: pointer;" class="text-danger">k04team</b> &mdash; version: <b class="text-primary">1.7.822</b></p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
